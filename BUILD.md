...
| M25 | _this commit_ | 294 | Citation-graph build-out for the other two domains: 4 synthesis queries on `ai-temporal-video` (temporal action detection, video-language grounding, long-form reasoning, object tracking) and 4 on `edge-ai-agentic` (on-device LLM inference, agentic workflows, edge inference infrastructure, transformer model compression). After all three domains: **148/363 sources cited overall (41%)** — ai-temporal 49%, GLP-1 40%, edge-ai 37%. Source orphans 312 → 215 (Δ-97). ~13 min `claude -p` total |
