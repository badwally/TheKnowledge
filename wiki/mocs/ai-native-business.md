...
last_updated: '2026-05-24T19:15:00Z'
draft: true
...
1. **Start with the concept anchor (`Key concepts` below)** to lock the substrate-first framing.
2. **Read the four pillars in order** — org → economics → tech → GTM (organized under `Synthesis pages`).
...
- [[entities/anysphere]] — Cursor parent; substrate-first AI coding boundary case.
- [[entities/cluely]] — "Momentum as moat" social-distribution exemplar.
- [[entities/cognition-labs]] — Devin; funded indie-archetype exemplar.
- [[entities/crosby-ai]] — Legal services AI-native firm.
- [[entities/decagon]] — Per-resolution outcome pricing exemplar.
- [[entities/gamma-app]] — "Made with Gamma" product-led distribution; player-coach org.
- [[entities/genspark]] — Substrate-vs-feature pivot exemplar; 60-contractor content network.
- [[entities/harvey-ai]] — Legal services AI-native firm.
- [[entities/lindy]] — Indie-archetype agentic workflow tool.
- [[entities/lovable-app]] — $50M ARR with <30 employees; substrate-first lean exemplar.
- [[entities/medvi]] — AI-mediated health brokering.
- [[entities/mercor]] — AI-powered recruiting marketplace; data-flywheel via AI-labs wedge.
- [[entities/polsia]] — Substrate-first AI-native referent.
- [[entities/sierra-ai]] — Funded indie-archetype exemplar.
- [[entities/surge-ai]] — $1B ARR at ~110 employees; capital-efficiency benchmark.

People (solo-buildable exemplars):

- [[entities/marc-lou]] — Indie-archetype solo-buildable proof.
- [[entities/pieter-levels]] — 12-startups-in-12-months; $3M+ ARR zero-employee.
...
### Archetype A — Indie SaaS / vertical agent
...
### Archetype C — Marketplace / aggregator
...
| **Total synthesis pages** | **22** | Substrate-first relocated to `wiki/concepts/`; remainder are drafts |
...
Known gaps and followups, filed at `docs/M46-followup-items.md`:
...
Out of scope for this playbook (deferred to followups):
