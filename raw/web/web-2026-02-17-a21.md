---
schema_version: 1
id: web-2026-02-17-a21
type: web
title: Brain-Score
url: https://www.brain-score.org/blog/leaderboard_overhaul/
authors:
- Brain-Score Team
published_at: '2026-02-17'
ingested_at: '2026-05-30T20:01:13Z'
content_hash: sha256:eed62e792767f2ead932cd501afa5bbc4eae83a2aac7e6ce6298f1433697bef1
domains: []
nlm_corpus_ids: []
wiki_pages: []
meta:
  ...
  archive_url: https://web.archive.org/save/https://www.brain-score.org/blog/leaderboard_overhaul/
filter:
  score: 0.7
---
Transformation of the Brain-Score leaderboard into a dynamic scientific exploration tool for understanding AI and brain alignment.
...
**Sharable, persistent views -**Every filter or configuration generates a unique URL, enabling you to:- Share a link with your collaborators and see exactly the same filtered view.
...
**Interested In The Technical Blog?** For implementation details keep an eye out on our technical blog. Contributions are welcome on GitHub.
