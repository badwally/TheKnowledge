...
ingested_at: '2026-05-23T18:35:39Z'
content_hash: sha256:2df72dc07a88e9a941777b290f675269667192eb7f3490f7734cc0bba6a1a6df
domains:
- ai-native-business
nlm_corpus_ids:
...
meta:
  ...
  site: dwarkesh.com
  excerpt: Working up from basic logic gates to why GPUs, TPUs, FPGAs, and the human
    brain each look the way they do.
  reading_time_minutes: 50
filter:
  score: 0.1
  policy_version: ai-native-business-v1
  rationale: 'This is a pure technical deep-dive into chip hardware architecture (logic
    gates, multiply-accumulate units, GPU/TPU design) with zero substantive content
    about operating an AI-native business. Despite Reiner Pope being a named founder
    and the source appearing on a quality platform (Dwarkesh Patel''s podcast), the
    actual content violates the exclusion criterion: ''Pure model-capability research
    (benchmarks, architectures, training) with no business-operating implications
    drawn out.'' No operating model, unit economics, GTM, or defensibility discussion
    present.'
  decided_at: '2026-05-23T18:36:03Z'
  user_correction:
    decided_at: '2026-05-23T18:46:12Z'
    score: 0.0
    rationale: Chip-design history; too far from solo-operator AI-native business
      playbook scope.
---
