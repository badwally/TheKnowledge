---
schema_version: 1
id: web-2026-05-27-cee
type: web
title: Time to take AI consciousness seriously
url: https://www.secondbest.ca/p/time-to-take-ai-consciousness-seriously
authors:
- Samuel Hammond
published_at: '2026-05-27'
ingested_at: '2026-05-30T18:49:23Z'
content_hash: sha256:b6675a61748f47c17a52296d1f1f1cdd7750bc567c11d925bf6e99c6d7696782
domains:
- convergent-ai-brain
nlm_corpus_ids: []
wiki_pages:
- wiki/entities/samuel-hammond.md
- wiki/entities/steven-byrnes.md
- wiki/entities/goldstein-2022-ecog.md
- wiki/entities/topolm.md
- wiki/concepts/universality-ml.md
- wiki/concepts/simulator-theory-llms.md
- wiki/concepts/persona-selection-model.md
- wiki/concepts/functional-brain-networks.md
meta:
  source_app: trafilatura
  site: secondbest.ca
  excerpt: The case for Claude and ChatGPT having subjective experiences
  reading_time_minutes: 20
  archive_url: https://web.archive.org/save/https://www.secondbest.ca/p/time-to-take-ai-consciousness-seriously
filter:
  score: 0.5
  policy_version: convergent-ai-brain-v1
  rationale: 'The article seriously engages brain-ANN convergence literature and explicitly
    discusses the Platonic Representation Hypothesis, universality, and compression
    as convergence drivers—directly addressing inclusion criterion #3. However, its
    primary thesis is about AI consciousness rather than representational alignment
    itself; while consciousness claims are grounded in cited alignment studies (Goldstein
    et al., TopoLM), the article is fundamentally a philosophy-of-mind essay using
    alignment evidence rather than an original alignment study. As a Substack synthesis
    piece rather than a peer-reviewed venue, it sits on the boundary between domain-relevant
    synthesis and consciousness-focused discourse without original empirical contribution.
    Merits human review to determine whether theoretical synthesis of brain-ANN convergence
    literature is in scope when the framing is consciousness rather than the alignment
    mechanisms themselves.'
  decided_at: '2026-05-30T18:49:57Z'
  user_correction:
    decided_at: '2026-05-30T18:50:02Z'
    score: 1.0
    rationale: Hand-picked bridge/entry-hub source. Hammond's essay synthesizes the
      domain's three threads (Platonic convergence + predictive processing + empirical
      brain-ANN alignment) and is a curated citation hub into the primary literature
      (Byrnes, Goldstein 2022 ECoG, TopoLM). Review-band score (0.5) reflects its
      essay/tech-blog form and consciousness framing; the consciousness layer is excluded
      at synthesis time, but the representational-convergence spine is squarely in
      scope.
---
...
It has long been established that the phasic firing of dopamine neurons resembles the reward prediction error (RPE) signal used by reinforcement learning algorithms. While the RPE theory of dopamine was too simplistic in its original form, a 2024 Nature Neuroscience perspective shows how a suitably generalized concept of prediction error can explain a wide range of its ostensible empirical challenges.

See, for example: Flesher, S. N. et al. (2021). “A brain-computer interface that evokes tactile sensations improves robotic arm control.” Science, 372, 831–836. Silicon BCIs can both read brain states and produce signals that translate to subjective sensations. This is hard to explain if the brain’s substrate is doing fundamentally different kinds of computation, much less if consciousness isn't computable in the first place.

There are many simplistic correlation studies of brain-AI alignment that may be spurious due to confounders. I’ve intentionally picked a subset of results that avoid these pitfalls. However, the capacity for deep learning models to emulate the brain does not rest on any one study, but rather multiple lines of evidence that should be understood holistically.

In a recent preprint, “Cognitive Dark Matter: Measuring What AI Misses,” Patrick Mineault, Thomas Griffiths, and Sean Escola propose a roadmap for augmenting AI training data in ways that could elicit training signal from brain functions that meaningfully shape behavior yet are hard to infer from behavioral data alone.
