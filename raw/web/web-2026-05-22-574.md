...
content_hash: sha256:ae8c69a1c1353735ad71c7582423db9cb47e0905ba5515ef5aa98b7e95cee56f
domains:
- ai-native-business
nlm_corpus_ids: []
wiki_pages: []
meta:
  ...
  site: latent.space
  excerpt: a quiet day lets us feature fundraises!
  reading_time_minutes: 8
filter:
  score: 0.48
  policy_version: ai-native-business-v1
  rationale: The article features venture-backed AI infrastructure companies (Modal
    at $4.7B, TurboPuffer at $100M ARR/profitable) with some business signals, but
    these are outside the solo-founder and tiny-team operating models the policy targets.
    While Latent Space is a quality publication and the TurboPuffer profitability
    claim is noteworthy, the content is primarily news aggregation and technology
    updates (model research, agent tooling, video generation, robotics) rather than
    founder-focused operational detail or unit economics analysis. The article lacks
    decomposition of operating models, cost structure, or GTM strategies relevant
    to the indie SaaS, services, or marketplace archetypes specified in the policy.
  decided_at: '2026-05-23T18:34:41Z'
  user_correction:
    decided_at: '2026-05-23T18:38:51Z'
    score: 1.0
    rationale: AI infra primitives (Exa, Modal, TurboPuffer) directly relevant to
      build-vs-buy defaults for solo operators.
---
...
**Turbopuffer**: $100M ARR and profitable (our podcast)**Exa**: $250M@$2.2B Series C (our podcast)**Modal**: $355M@$4.7B Series C (our podcast)
