...
meta:
  ...
  site: sequoiacap.com
  excerpt: One year ago, we published a hypothesis that generative AI would become
    a profound platform shift in technology. Then came the firestorm.
  reading_time_minutes: 12
filter:
  score: 0.58
  policy_version: ai-native-business-v1
  rationale: Credible tier-one VC essay with substantive market analysis, named companies
    (Harvey, Midjourney, Character), and product pattern discussion (agentic systems,
    reasoning techniques, tech stack mentions). However, it lacks concrete solo-founder
    operating models, unit economics with numbers, and operator-specific implementation
    detail—it's market-trend analysis rather than an operator playbook. Marginally
    above threshold but genuinely borderline for review.
  decided_at: '2026-05-23T18:50:22Z'
