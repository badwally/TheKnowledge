...
content_hash: sha256:5ccd73d43737013736633c65498d78173f276a520a05fa8a9b596bf9f90eaf06
domains:
- ai-native-business
nlm_corpus_ids:
...
meta:
  ...
  site: thezvi.substack.com
  excerpt: Google once again has a model worth at least some consideration.
  reading_time_minutes: 10
filter:
  score: 0.35
  policy_version: ai-native-business-v1
  rationale: Model evaluation essay with community reactions; lacks the operating-model,
    unit-economics, and business-strategy focus required by policy. While it touches
    on builder use cases and tool selection, it's primarily model-capability research
    (benchmarks, speed, cost comparison) without grounded implications for how solo
    founders or tiny teams structure their businesses. Developer commentary on model
    choice is peripheral to the core domain of AI-native business design.
  decided_at: '2026-05-23T18:35:38Z'
  user_correction:
