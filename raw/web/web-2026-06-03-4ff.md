...
nlm_corpus_ids: []
wiki_pages:
- wiki/entities/azure-confidential-clean-rooms.md
- wiki/entities/confidential-consortium-framework.md
- wiki/concepts/data-clean-room.md
- wiki/concepts/trusted-execution-environment.md
- wiki/concepts/confidential-computing.md
- wiki/concepts/remote-attestation.md
- wiki/concepts/query-output-controls.md
meta:
...
filter:
  ...
  user_correction:
    ...
    score: 1.0
    rationale: Azure Confidential Clean Rooms — a DEPLOYED commercial clean-room/TEE
      substrate letting parties pool data without exposing raw records to each other
      or the operator (criterion 2 + named architecture, criterion 4).
---
Note
