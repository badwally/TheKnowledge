...
content_hash: sha256:6371da8be77658ff535e056eb02271fec9d627e4f16066fa209de797824e34d3
domains:
- ai-native-business
nlm_corpus_ids:
...
meta:
  ...
  site: levels.io
  excerpt: I liked the idea of Jennifer Dewalt’s 180 websites in 180 days [http://jenniferdewalt.com/].
    However, unlike Jennifer who learned web development from scratch, I can already
    build stuff. My challenge is to actually finish and launch my projects. So for
    the next 12 months, I’ve set the
  reading_time_minutes: 6
filter:
  score: 0.4
  policy_version: ai-native-business-v1
  rationale: 'Founder operating essay with first-hand shipping discipline and launch
    strategy from Pieter Levels, but predates the AI era (2014) and lacks engagement
    with the policy''s core scope: AI-native operating models, agent-human team composition,
    and the one-operator-plus-agents archetype. While execution wisdom applies broadly,
    the post addresses general solo-founder challenges without addressing AI-substrate-specific
    decisions. Merits human review given author credibility but falls below inclusion
    threshold.'
  decided_at: '2026-05-23T18:48:31Z'
  user_correction:
    decided_at: '2026-05-23T18:50:21Z'
    score: 1.0
    rationale: Pieter Levels '12 Startups in 12 Months' — canonical solo-operator
      manifesto cited throughout the indie SaaS / AI-native solo founder archetype.
---
