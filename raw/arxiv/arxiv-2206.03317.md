...
nlm_corpus_ids: []
wiki_pages:
- wiki/entities/subject-membership-inference-paper.md
- wiki/concepts/subject-membership-inference-attack.md
- wiki/concepts/subject-level-privacy.md
- wiki/concepts/cross-silo-federated-learning.md
meta:
  arxiv_id: '2206.03317'
  categories:
  - cs.LG
...
filter:
  ...
  user_correction:
    ...
    score: 1.0
    rationale: Subject membership-inference attacks in cross-silo federated learning
      — a privacy risk specific to multi-organization data pooling (criterion 2).
---
